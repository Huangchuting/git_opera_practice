...
.demo-16{
    ...
    .btn {
        $hue: 330;
        $btn-bg-color: hsl($hue, 100%, 50%);
        $btn-bg-color-darker: hsl($hue, 100%, 45%);
        position: relative;
        ...
        &-bubbles {
            ...
            &:before {
                ...
                background-repeat: no-repeat;
                background-image: bubbles($btn-bg-color);
            ...
            &:active {
                ...
                background: $btn-bg-color-darker;
